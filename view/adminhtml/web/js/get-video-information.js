                ...
                _create: function() {
                    switch (this.element.data('type')) {
                        ...
                        case 'vimeo':
                            ...
                            break;
                        case 'pixelbin':
                            this.element.videopixelbin();
                            this._player = this.element.data('mageVideopixelbin');
                            break;
                        default:
                            throw {
        ...
        $.widget(
            'mage.videoData', {
                ...
                _validateURL: function(href, forceVideo) {
                    ...
                    } else if (href.host.match(/pixelbin/) || href.href.includes(cname)) {
                        type = 'pixelbin';
